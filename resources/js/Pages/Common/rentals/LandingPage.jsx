...
export default function LandingPage() {
  ...
  const handleSearch = (e) => {
    ...
    const filtered = hotels.filter(hotel => {
      ...
      const matchesPackage = !searchPackageType || hotel.packageType === searchPackageType;
      return matchesDestination && matchesPackage;
    });
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-4 sm:p-5 w-full max-w-5xl mx-auto animate-fade-in-up overflow-hidden" style={{ animationDelay: '0.4s' }}>
              <form onSubmit={handleSearch} className="relative">
                  ...
                  <div className="flex flex-col px-3 py-2 sm:border-r border-gray-200/70">
                    ...
                    <div className="relative group">
                      <input
                        ...
                        readOnly
                        className="w-full py-3 pl-4 pr-10 bg-gray-50/80 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 hover:border-blue-200 group-hover:shadow-sm cursor-pointer"
                      />
                      <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <div className="p-1 rounded-full bg-blue-50 group-hover:bg-blue-100 transition-colors duration-300">
                          <Calendar className="h-4 w-4 text-blue-500" />
                    ...
                    {showDatePicker && (
                      <div className="absolute z-50 mt-2 bg-white rounded-xl shadow-lg p-4 border border-gray-200">
                        ...
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <button 
                            onClick={() => handleDateSelect("25 Jul - 30 Jul 2025")}
                ...
                <div className="mt-4 px-3">
                  <button 
                    type="submit"
                    className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-xl transition-colors duration-300 flex items-center justify-center gap-2"
                  >
